    ...
    <Card className="w-full max-w-2xl mx-auto">
      ...
      <CardContent className="space-y-6">
        ...
        <div className="pt-4 border-t space-y-2">
          <Label htmlFor="obs4" className="text-muted-foreground">Observações do Professor(a):</Label>
          <Textarea
            id="obs4"
            placeholder="Adicione observações sobre o desempenho do aluno..."
            value={state.observations[4] || ''}
            onChange={(e) => setObservation(4, e.target.value)}
            rows={3}
          />
        </div>
      </CardContent>
